...
;!function(a){"use strict";var b=a.module("angular-bind-html-compile",[]);b.directive("bindHtmlCompile",["$compile",function(a){return{restrict:"A",link:function(b,c,d){b.$watch(function(){return b.$eval(d.bindHtmlCompile)},function(e){c.html(e&&e.toString());var f=b;d.bindHtmlScope&&(f=b.$eval(d.bindHtmlScope)),a(c.contents())(f)})}}}])}(window.angular);;/*! jQuery v2.2.4 | (c) jQuery Foundation | jquery.org/license */
...
;angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('templates/github_card.tpl.html',
    "<script>console.log('ready');</script><style>.gh { /* local reset */\n" +
    "    margin: 0;\n" +
    "    padding: 0;\n" +
    "    border: 0;\n" +
    "    font-size: 100%;\n" +
    ...
    "    padding-right: 11px;\n" +
    "    padding-bottom: 9px\n" +
    "  }</style><div class=\"gh gh-report-card\"><div class=\"gh gh-header\"><div class=\"gh gh-octocat\"><svg version=1.1 id=Layer_1 xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink x=0px y=0px width=21.292px height=22px viewBox=\"0 0 21.292 22\" style=\"enable-background:new 0 0 21.292 22\" xml:space=preserve><g><defs><ellipse id=SVGID_1_ cx=10.713 cy=11 rx=10.421 ry=\"11\"/></defs><clipPath id=SVGID_2_><use xlink:href=#SVGID_1_ style=\"overflow:visible\"/></clipPath><g style=clip-path:url(#SVGID_2_)><defs><rect id=SVGID_3_ x=0.292 width=21 height=\"22\"/></defs><clipPath id=SVGID_4_><use xlink:href=#SVGID_3_ style=\"overflow:visible\"/></clipPath><rect x=-4.708 y=-5 style=clip-path:url(#SVGID_4_);fill-rule:evenodd;clip-rule:evenodd;fill:#FAFAFB width=30.842 height=\"32\"/></g></g><g><defs><path id=SVGID_5_ d=\"M10.712,0C4.958,0,0.292,4.784,0.292,10.685c0,4.72,2.986,8.725,7.127,10.138\n" +
    ...
    "            c4.137-1.416,7.12-5.417,7.12-10.137C21.134,4.784,16.468,0,10.712,0\"/></defs><clipPath id=SVGID_6_><use xlink:href=#SVGID_5_ style=\"overflow:visible\"/></clipPath><g style=clip-path:url(#SVGID_6_)><defs><rect id=SVGID_7_ x=0.292 width=21 height=\"22\"/></defs><clipPath id=SVGID_8_><use xlink:href=#SVGID_7_ style=\"overflow:visible\"/></clipPath><rect x=-4.708 y=-5 style=clip-path:url(#SVGID_8_);fill-rule:evenodd;clip-rule:evenodd;fill:#767676 width=30.842 height=\"30.842\"/></g></g></svg></div><span class=gh-title>Github Report</span><div class=\"gh gh-avatar\"></div><div class=\"gh gh-username\"></div><div class=\"gh gh-recently-active gh-hidden\"><span class=\"gh gh-greenbox\"></span> <span class=\"gh gh-recent-txt\">Recently Active</span></div></div><div class=\"gh gh-contents\"><p class=\"gh gh-repos\"></p><p class=\"gh gh-gists\"></p></div><div class=\"gh gh-languages\"></div></div>"
  );


  $templateCache.put('templates/portfolio.tpl.html',
    "<div class=\"animated fadeIn\"><div layout=row layout-align=\"center center\"><div class=\"portfolio-header md-whiteframe-z5 clearfix\" layout-padding flex-xs=99 flex-sm=95 flex-md=85 flex-gt-md=70><div><img id=me src=\"img/me.png\"></div><div class=\"name centered-margins secondary-grey-lighten-4\">John <span class=secondary-grey-lighten-1>Anthony</span> Rivera</div><div layout=row layout-wrap layout-align=\"space-around center\"><div class=contact-item>951-553-4461</div><div class=contact-item>johnanthony.dev@gmail.com</div><a class=contact-item href=https://github.com/coffeeexistence>Github</a> <a class=contact-item href=\"http://johnanthony-dev.com/blog/\">Blog</a></div></div></div><repo-display></repo-display><div layout=row class=portfolio-section flex=99 layout-align=\"space-around start\"><div class=portfolio-section layout=row layout-wrap layout-align=\"space-around start\" flex-xs=95 flex-sm=95 flex-md=85 flex-gt-md=70><div id=left class=\"portfolio-section primary-color\" flex-gt-md=75 flex=99 layout=column layout-wrap><div id=experience><h2>Technical Experience</h2><div class=indented><div ng-repeat=\"project in ctrl.technicalExperience\"><portfolio-project project=project></portfolio-project><md-divider ng-if=!$last></md-divider></div></div></div><div id=history><h2 class=primary-color>Employment History</h2><md-list class=\"indented secondary-grey-lighten-3\"><div ng-repeat=\"job in ctrl.history\"><h3 class=header>{{job.name}}</h3><div class=subheader><span class=text-grey>{{job.title}}</span> <span class=text-grey>({{job.dateString}})</span></div><md-list-item ng-repeat=\"point in job.points\"><div class=list-item>{{point}}</div></md-list-item><md-divider ng-if=!$last></md-divider></div></md-list></div></div><div id=right class=\"skill-set secondary-grey\" flex-gt-md=25 flex=99 layout=column layout-fill layout-align=\"start start\"><h2>Skill Set</h2><div layout=row layout-align=\"space-between space-between\" layout-align-gt-md=\"start space-between\" layout=row layout-fill layout-wrap><div class=skill ng-repeat=\"tier1 in ctrl.skills\"><h3>{{tier1.title}}</h3><div class=sub-skill ng-repeat=\"tier2 in tier1.subSkills\"><h4>{{tier2.title}}</h4><div class=sub-skill ng-repeat=\"tier3 in tier2.subSkills\"><h5>{{tier3.title}}</h5></div></div></div></div></div></div></div></div>"
  );
  ...
  $templateCache.put('templates/repo_display.tpl.html',
    "Hello!<div style=margin:2em ng-repeat=\"file in browser.files\"><p ng-bind-html=\"file.text | codify\"></p></div>"
  );
