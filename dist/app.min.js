...
;function PortfolioController($sce){var ctrl=this;ctrl.skills=[{title:"Ruby",subSkills:[{title:"Test Driven Development"},{title:"Refactoring"},{title:"Best Practices"},{title:"Object Orientation",subSkills:[{title:"Attribute Accessors"},{title:"Instance & Class Methods"}]},{title:"Rails Framework",subSkills:[{title:"ActiveRecord"},{title:"ActiveView"},{title:"Controllers"},{title:"Devise"},{title:"ERB"},{title:"Deployment"}]}]},{title:"JavaScript",subSkills:[{title:"AngularJS",subSkills:[{title:"Controllers"},{title:"Directives"},{title:"Services"},{title:"Routing"},{title:"Asynchronous callbacks"},{title:"$scope"},{title:"$http"}]},{title:"jQuery"}]},{title:"HTML & CSS",subSkills:[{title:"Formatting"},{title:"Positioning"},{title:"Selectors"},{title:"Media Queries"},{title:"SASS"}]}],ctrl.technicalExperience=[{name:"MixCritic",description:"Website where artists and producers can post their mixes for constructive feedback.",points:["Created RESTful Rails API for Angular Frontend","Used ActiveRecord to store model data in postgres database","Constructed versatile and reusable AngularJS directives & controllers","Worked with asynchronous callbacks","Integrated Material Design for user interface","Connected to Amazon S3 for data storage"],links:[{title:"Video Walkthrough",url:"https://www.youtube.com/watch?v=SlNoUv6_LnQ"},{title:"Github",url:"https://github.com/coffeeexistence/mixcritic-angular"},{title:"Live Demo",url:"http://mix-critic.herokuapp.com/"}]},{name:"Movie Scraper",description:"Collects local movie theater showtimes and fetches ratings.",points:["Scraped from Fandango and Rottentomatoes using Nokogiri ","Accessed movie theater distance information via Google Maps API","Collected and sorted movies by rating"],links:[{title:"Video Walkthrough",url:"https://www.youtube.com/watch?v=U_UHuH6WQjM"},{title:"Github",url:"https://github.com/coffeeexistence/LocalMovies-project"}]},{name:"Tic Tac Toe AI",description:"Will always end in a Win or “Cat’s Game”, if maximum difficulty is selected.",points:["Recursively searches through each possible move and sub-moves, calculates wins, losses, or draws"],links:[{title:"Gist",url:"https://gist.github.com/coffeeexistence/02130b87bfd085711cca9f124aba89e2"}]}],ctrl.history=[{name:"Autocross Performance & Muffler",location:"Lake Elsinore, CA",title:"Tech Guy",dateString:"March 2015 - April 2016 + Ongoing Remote Technical Assistance",points:["Devised database schemas for storing customer, invoice, and product information","Built invoice generator which has been used for over 500 transactions","Calculated current and projected financial stats for budgeting and business planning","Created advertising material, website, and social media presence","Assisted customers purchasing products and services","Filed 2015 Taxes (State & Federal) in early 2016"]},{name:"Uhaul Moving & Storage",location:"Murrieta, CA",title:"Customer Service Representative",dateString:"October 2015 - Present",points:["Installed hitches, vehicle wiring systems, and brake controllers","Provided excellent & helpful customer service","Sold sales items","Received, inspected, and dispatched vehicles "]},{name:"Albertson's",location:"Murrieta, CA",title:"Meat Department Clerk",dateString:"June  2015 - December 2015",points:["Handled, cut, and prepared meat and seafood","Cleaned, maintained displays, and answered calls"]}],ctrl.education=[{name:"Flatiron School",graduation:"2016",description:"Full Stack Web Development, Ruby on Rails and JavaScript online program"},{name:"High School",graduation:"2014",description:""}]}function portfolioProject(){return{restrict:"E",scope:{project:"="},controller:function($scope,$sce){var ctrl=this;ctrl.expanded=!1,ctrl.toggleExpansion=function(){ctrl.expanded=!ctrl.expanded}},controllerAs:"projectCtrl",templateUrl:"templates/project.tpl.html",link:function(scope,elem,attrs,ctrl){}}}function TicTacController($sce,$scope,TicTacApi){var ctrl=this;$scope.loaded=!1,ctrl.init=function(){TicTacApi.create({game_session:{ai_difficulty:"5"}}).then(ctrl.loadGame)},ctrl.loadGame=function(response){$scope.game=ctrl.responseToGame(response),$scope.loaded=!0},ctrl.responseToGame=function(response){var game=response.data;return game.board=game.board_state.split(""),game},ctrl.init()}function TicTacApi($http){var service=this,apiPath="http://localhost:3000/api/game";service.create=function(data){return $http.post(apiPath,data)},service.show=function(id){return $http.get(apiPath+"/"+id)},service.update=function(id,data){return $http.post(apiPath+"/"+id,data)},service.aiMove=function(id,data){return $http.get(apiPath+"/"+id+"/ai_move")}}function gameSlot(){return{restrict:"A",scope:{index:"="},controller:["$sce","$scope",function($sce,$scope){var ctrl=this;$scope.show=!1,ctrl.load=function(index){$scope.index=index,$scope.show=!0},ctrl.slot=function(){var slot=$scope.$parent.game.board[$scope.index];return" "===slot&&(slot="empty"),slot}}],controllerAs:"slotCtrl",template:['<td ng-if="show">{{slotCtrl.slot()}} - {{index}}</td>'].join(""),link:function(scope,elem,attrs,ctrl){scope.$watch("index",function(index){void 0!==index&&(ctrl.load(index),console.log(index))})}}}angular.module("app",["ngMaterial","ui.router","ngSanitize"]).config(function($httpProvider,$stateProvider,$urlMatcherFactoryProvider,$sceDelegateProvider){$httpProvider.defaults.useXDomain=!0,delete $httpProvider.defaults.headers.common["X-Requested-With"],$sceDelegateProvider.resourceUrlWhitelist(["self","https://www.youtube.com/embed/**"]),$urlMatcherFactoryProvider.strictMode(!1),$stateProvider.state("portfolio",{url:"",templateUrl:"templates/portfolio.tpl.html",controller:"PortfolioController",controllerAs:"ctrl"}).state("tictac",{url:"/tictac",templateUrl:"templates/tictac.tpl.html",controller:"TicTacController",controllerAs:"TicTacCtrl"})}),angular.module("app").run(["$templateCache",function($templateCache){"use strict";$templateCache.put("templates/portfolio.tpl.html",'<div layout=row layout-align="center center"><div class="portfolio-header md-whiteframe-z2 clearfix" layout-padding flex-gt-sm=70 flex=100><div><img id=me src="img/me.png"></div><div class="name centered-margins">John Anthony Rivera</div><div layout=row layout-wrap layout-align="space-around center"><div class=contact-item>951-553-4461</div><div class=contact-item>johnanthony.dev@gmail.com</div><div class=contact-item>github: coffeeexistence</div><div class=contact-item>johnanthony-dev.com</div></div></div></div><div layout=row layout-align="center center"><div layout=row layout-wrap layout-align="start start" flex-gt-sm=70 flex=99><div id=left flex-gt-xs=60 flex-xs=100 layout=column layout-wrap><div id=experience><h2>Technical Experience</h2><div class=indented><div ng-repeat="project in ctrl.technicalExperience"><portfolio-project project=project></portfolio-project><md-divider ng-if=!$last></md-divider></div></div></div><div id=history><h2>Employment History</h2><md-list class=indented><div ng-repeat="job in ctrl.history"><h3>{{job.name}}</h3><md-list-item ng-repeat="point in job.points"><div class=md-list-item-text>{{point}}</div></md-list-item><md-divider ng-if=!$last></md-divider></div></md-list></div></div><div id=right class=skill-set flex-gt-xs=30 flex-xs=100 layout=column layout-align="start start"><h2>Skill & Competencies</h2><div class=skill ng-repeat="tier1 in ctrl.skills"><h3>{{tier1.title}}</h3><div class=sub-skill ng-repeat="tier2 in tier1.subSkills"><h4>{{tier2.title}}</h4><div class=sub-skill ng-repeat="tier3 in tier2.subSkills"><h5>{{tier3.title}}</h5></div></div></div></div></div></div>'),$templateCache.put("templates/project.tpl.html",'<div ng-click=projectCtrl.toggleExpansion(); ng-mouseover="hover=true" ng-mouseleave="hover=false" ng-class="{\'hovered\': hover, \'md-whiteframe-z2 expanded\': projectCtrl.expanded}" class="noborder project-container"><div class=slight-indent><div layout=row layout-align="space-between center"><h3>{{project.name}}</h3><div ng-show=hover class=hover-text><span ng-show=!projectCtrl.expanded>(Click to expand)</span> <span ng-show=projectCtrl.expanded>(Click to collapse)</span></div></div><div class=list-item ng-repeat="point in project.points"><div>{{point}}</div></div><md-divider ng-if=projectCtrl.expanded></md-divider><div ng-show=projectCtrl.expanded class=project-extra-content layout=row layout-xs=column layout-align="space-around center" ng-click=""><a ng-repeat="link in project.links" ng-href={{link.url}}>{{link.title}}</a></div></div></div>'),$templateCache.put("templates/tictac.tpl.html","I AM TIC TAC<div ng-if=loaded layout=column layout-wrap><h3>Your session id is: {{game.id}}</h3>{{game}}<hr><table class=game-board border=1 cellpadding=40><tr><td game-slot index=0></td><td game-slot index=1></td><td game-slot index=2></td></tr><tr><td game-slot index=3></td><td game-slot index=4></td><td game-slot index=5></td></tr><tr><td game-slot index=6></td><td game-slot index=7></td><td game-slot index=8></td></tr></table><br></div>")}]),angular.module("app").controller("PortfolioController",PortfolioController),angular.module("app").directive("portfolioProject",portfolioProject),angular.module("app").controller("TicTacController",["$sce","$scope","TicTacApi",TicTacController]),angular.module("app").service("TicTacApi",["$http",TicTacApi]),angular.module("app").directive("gameSlot",gameSlot);